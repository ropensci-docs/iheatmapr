...
(e.g. [heatmaply](https://github.com/talgalili/heatmaply) and
[d3heatmap](https://github.com/talgalili/d3heatmap)) or complex static
...
For an overview of how to use `iheatmapr`, please see the [documentation
website](https://docs.ropensci.org/iheatmapr/).
